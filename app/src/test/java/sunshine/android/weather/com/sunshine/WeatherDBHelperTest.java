...
public class WeatherDBHelperTest extends SQLiteOpenHelper {


    public WeatherDBHelperTest(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
